...
$(document).ready(function () {
	...
	initT();
	function scrolls(){
		var pos_top = $('.section_down')[0].getBoundingClientRect().bottom,
			pos_bottom = $('.section_down')[0].getBoundingClientRect().bottom,
			tp = $(window).height(),
			object = $('.section_down');
			console.log(pos_top, pos_bottom, tp)
	...
	function StartStop() {
		var pos_bg = $('.section_bg-4')[0].getBoundingClientRect().bottom;
		var top = $(window).height();
		var anim = $('.animation-1');
		var cat = $('.links_catalog');
		var blur = $('.blur-box')
		...
		if (flag === true) {
			$('.animation-1').animateSprite('stop')
			cat.addClass('show')
			blur.addClass('blur')
			count = true;
			console.log('stop')
			...
			$('.animation-1').animateSprite('resume')
			count = false;
